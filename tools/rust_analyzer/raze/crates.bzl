...
def rules_rust_ra_fetch_remote_crates():
    """This function defines a collection of repos and should be called in a WORKSPACE file"""
    maybe(
        http_archive,
        name = "rules_rust_ra__ansi_term__0_11_0",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__anyhow__1_0_38",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__atty__0_2_14",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__bitflags__1_2_1",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__clap__2_33_3",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__heck__0_3_2",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__hermit_abi__0_1_18",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__lazy_static__1_4_0",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__libc__0_2_86",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__proc_macro_error__1_0_4",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__proc_macro_error_attr__1_0_4",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__proc_macro2__1_0_24",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__quote__1_0_9",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__strsim__0_8_0",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__structopt__0_3_21",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__structopt_derive__0_4_14",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__syn__1_0_60",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__textwrap__0_11_0",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__unicode_segmentation__1_7_1",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__unicode_width__0_1_8",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__unicode_xid__0_2_1",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__vec_map__0_8_2",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__version_check__0_9_2",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__winapi__0_3_9",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__winapi_i686_pc_windows_gnu__0_4_0",
    ...
    maybe(
        http_archive,
        name = "rules_rust_ra__winapi_x86_64_pc_windows_gnu__0_4_0",
